...
#if (defined TCFG_FIX_CLOCK_FREQ  && ((TCFG_FIX_CLOCK_FREQ == 240000000) || (TCFG_FIX_CLOCK_FREQ == 160000000)))|| TCFG_IIS_NODE_ENABLE || TCFG_IIS_RX_NODE_ENABLE
...
#if (defined TCFG_FIX_CLOCK_FREQ && (TCFG_FIX_CLOCK_FREQ == 192000000))
    clk_early_init(PLL_REF_XOSC_DIFF, TCFG_CLOCK_OSC_HZ, 192 * MHz);
#else
    clk_early_init(PLL_REF_XOSC_DIFF, TCFG_CLOCK_OSC_HZ, 240 * MHz);
#endif
