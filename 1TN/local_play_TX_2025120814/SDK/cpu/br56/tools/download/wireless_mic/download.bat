...
@echo on
..\..\isd_download.exe ..\..\isd_config.ini -tonorflash -dev br56 -boot 0x100000 -div8 -wait 300 -uboot ..\..\uboot.boot -app ..\..\app.bin %TONE_FILES% -res cfg_tool.bin stream.bin %KEY_FILE% %FORMAT% -output-fw jl_isd.fw -output-ufw update.ufw
@echo off
