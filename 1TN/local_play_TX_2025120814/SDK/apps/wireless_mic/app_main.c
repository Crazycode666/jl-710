...
static void app_poweron_check(int update)
{
    ...
    if (is_gpio_wakeup(TCFG_CHARGESTORE_PORT)) {
        app_var.play_poweron_tone = 0;
        return;
    }
#endif
...
static void debug_timer(void *p)
{
    task_info_output(0);
    mem_stats();
}
...
extern void led_water_flash_add();
extern void echo_led_on(u32 port,u32 pin,u32 gpio_port);

extern void Display_Scan1(void);
extern void user_vbat_display_add();
extern void user_vbat_init();
