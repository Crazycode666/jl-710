...
const int key_bt_ad_num0_msg_table[KEY_ACTION_MAX] = {
    APP_MSG_WIRELESS_MIC_TX_VOL_MUTE,    APP_MSG_KEY_POWER_OFF,  APP_MSG_KEY_POWER_OFF_HOLD,
    APP_MSG_KEY_POWER_OFF_RELEASE,  APP_MSG_WIRELESS_MIC_TX_MONIROT_VOL_MUTE, APP_MSG_VOCAL_REMOVE,
};
