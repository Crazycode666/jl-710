...
#ifdef TCFG_BB_PKT_V3_LEVEL_SEL
#undef TCFG_BB_PKT_V3_LEVEL_SEL
#define TCFG_BB_PKT_V3_LEVEL_SEL 1 // pkt_v3挡位选择
#endif
...
#define WIRELES_MIC_1TNR_MODE   0
#define WIRELES_MIC_1T1R_MODE   1
#define WIRELES_MIC_2T1R_MODE   2
#define ADAPTER_2T1R_MODE       3

#if TCFG_BB_PKT_V3_EN
#define LE_PKT_V3_CODE_AT_RAM
#endif

#define LE_BB_IRQ_CODE_AT_RAM
#define LE_LL_IRQ_CODE_AT_RAM
#define LE_AFH_CODE_AT_RAM
