...
#define APP_MSG_KEY_VALUE(msg)  ((msg >> 24) & 0xff)

#define APP_MSG_KEY_ACTION(msg)  ((msg >> 16) & 0xff)
...
enum {
    ...
    APP_MSG_LE_FIRST_CONNECT,
    APP_MSG_LE_SECOND_CONNECT,
    APP_MSG_LE_FIRST_DISCONNECT,
    APP_MSG_LE_SECOND_DISCONNECT,
    ...
    APP_MSG_WIRELESS_MIC_TX_VOL_MUTE,
    APP_MSG_WIRELESS_MIC_TX_MONIROT_VOL_MUTE,
    APP_MSG_WIRELESS_MIC_TX_VOL_UP,
    APP_MSG_WIRELESS_MIC_TX_VOL_DOWN,
    APP_MSG_WIRELESS_MIC_TX_MONITOR_VOL_UP,
    APP_MSG_WIRELESS_MIC_TX_MONITOR_VOL_DOWN,
    ...
    APP_MSG_LLNS_BYPASS,
    APP_MSG_LLNS_DNS_SW_LLNS,

    APP_MSG_WIRELESS_MIC_1TN_ENTER_UPDATE,
    APP_MSG_WIRELESS_MIC_1TN_EXIT_UPDATE,
