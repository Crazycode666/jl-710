...
static int led_ui_normal_status_deal(u8 *status)
{
    ...
    case LED_STA_POWERON:
        led_ui_set_state(LED_STA_RED_ON, 0);
...
static int ui_led_app_msg_entry(int *msg)
{
    ...
    case APP_MSG_LE_FIRST_CONNECT:
    case APP_MSG_LE_SECOND_CONNECT:
        led_app_ui_set(LED_STA_BT_CONN);
        break;
    case APP_MSG_LE_FIRST_DISCONNECT:
    case APP_MSG_LE_SECOND_DISCONNECT:
        led_app_ui_set(LED_STA_BT_DISCONN);
        break;
#endif
