...
#if (TCFG_LE_AUDIO_APP_CONFIG == LE_AUDIO_JL_BIS_TX_EN) // le_audio 应用选择
    volume_ioc_get_cfg("Vol_WMicTX", &music_vol_cfg);
    volume_ioc_get_cfg("Vol_WMicTX", &call_vol_cfg);
    volume_ioc_get_cfg("Vol_WMicTX", &tone_vol_cfg);
    volume_ioc_get_cfg("Vol_WMicTX", &ktone_vol_cfg);
    volume_ioc_get_cfg("Vol_WMicTX", &ring_vol_cfg);
#else
    volume_ioc_get_cfg("Vol_WMic0", &music_vol_cfg);
    volume_ioc_get_cfg("Vol_WMic0", &call_vol_cfg);
    volume_ioc_get_cfg("Vol_WMic0", &tone_vol_cfg);
    volume_ioc_get_cfg("Vol_WMic0", &ktone_vol_cfg);
    volume_ioc_get_cfg("Vol_WMic0", &ring_vol_cfg);
#endif
#else
