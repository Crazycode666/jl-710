...
const u16 bt_key_io_table[KEY_IO_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
        KEY_CHANGE_MODE,	KEY_CALL_HANG_UP,	KEY_NULL,	KEY_NULL,	KEY_CONNECTED_SW,	KEY_WIRELESS_PAIR_INFO_REMOVE
    },
    [1] = {
...
const u16 live_mic_key_io_table[KEY_IO_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [0] = {
        ...
        KEY_MULTI_CAPTURE_MIC_PP,	KEY_POWEROFF,	KEY_POWEROFF_HOLD,	KEY_NULL,	KEY_CONNECTED_SW,	KEY_WIRELESS_PAIR_INFO_REMOVE
#elif (WIRELESS_2T1_DUPLEX_ROLE == ROLE_CENTRAL)
        KEY_DIG_GROUP_TRANS_PP,	KEY_POWEROFF,	KEY_POWEROFF_HOLD,	KEY_NULL,	KEY_CONNECTED_SW,	KEY_WIRELESS_PAIR_INFO_REMOVE
#else
