...
#define TCFG_AUDIO_MIC1_MODE                AUDIO_MIC_CAP_DIFF_MODE //AUDIO_MIC_CAP_MODE
#define TCFG_AUDIO_MIC2_MODE                AUDIO_MIC_CAP_DIFF_MODE //AUDIO_MIC_CAP_MODE
...
//配置MIC电源
#define TCFG_AUDIO_MIC_PWR_CTL              MIC_PWR_FROM_MIC_BIAS//MIC_PWR_FROM_GPIO

//使用普通IO输出供电:不用的port配置成NO_CONFIG_PORT
#if (TCFG_AUDIO_MIC_PWR_CTL & MIC_PWR_FROM_GPIO)
#define TCFG_AUDIO_MIC_PWR_PORT             IO_PORTG_07//IO_PORTC_02
...
//                                  LED 配置                                       //
//*********************************************************************************//
#define TCFG_PWMLED_ENABLE					ENABLE_THIS_MOUDLE//DISABLE_THIS_MOUDLE			//是否支持PMW LED推灯模块
#define TCFG_PWMLED_IOMODE					LED_ONE_IO_MODE				//LED模式，单IO还是两个IO推灯
#define TCFG_PWMLED_PIN						IO_PORTG_05					//LED使用的IO口

#define TCFG_PWMLED_PIN0						IO_PORTG_08				//4脚
#define TCFG_PWMLED_PIN1						IO_PORTB_02				//13脚
#define TCFG_PWMLED_PIN2						IO_PORTB_03			    //12脚
#define TCFG_PWMLED_PIN3						IO_PORTC_03	            //22脚
#define TCFG_PWMLED_PIN4						IO_PORTC_02	            //23脚
...
//                          新音箱配置工具 && 调音工具                             //
//*********************************************************************************//
#define TCFG_CFG_TOOL_ENABLE				1//DISABLE		  	//是否支持音箱在线配置工具
...
#define TCFG_MIC_EFFECT_SEL          	MIC_EFFECT_REVERB_ECHO//MIC_EFFECT_REVERB
