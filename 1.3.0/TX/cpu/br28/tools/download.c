...
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO_ADVANCE) && defined(MIC_EFFECT_EQ10)&& MIC_EFFECT_EQ10
cp ./EFF_DIR/mic_effect_full_advance_eq10.bin eq_cfg_hw.bin
...
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO_ADVANCE) && defined(MIC_EFFECT_EQ10)&& MIC_EFFECT_EQ10
copy .\EFF_DIR\mic_effect_full_advance_eq10.bin eq_cfg_hw.bin
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO_ADVANCE)
